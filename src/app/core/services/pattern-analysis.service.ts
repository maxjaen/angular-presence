...
import { Pattern } from '../models/enums';
...
export class PatternAnalysisService {
    ...
    /**
     * Get all exercises in a training that match the name value of the input exercise.
     *
    ...
    /**
     * Calculates the sum of data for each exercise to make it comparable with other exercises.
     *
    ...
    /**
     * Creates a string representation for the specified records of each exercise.
     *
    ...
    /**
     * Get all exercises in a training that matches the name value of the input exercise.
     *
